        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              <PackageCardGamma
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/package/p-gumma1.png"}
              ...
              />
              <PackageCardGamma
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/package/p-gumma5.png"}
                cardLavel="3 Day &amp; 2 night"
                title="Aenean auctor porta sodales nullam suspendisse fringilla neque."
                price=" $52.00"
              />
              <PackageCardGamma
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/package/p-gumma2.png"}
                cardLavel="3 Day &amp; 2 night"
                title="San francisco golden gate bridge, cable cars & fog."
                price=" $55.00"
              />
              <PackageCardGamma
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/package/p-gumma3.png"}
                cardLavel="3 Day &amp; 3 night"
                title="Duis pretium sit amet nisi a justont malesuada fusce congue."
                price=" $88.00"
              />
              <PackageCardGamma
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/package/p-gumma4.png"}
                cardLavel="3 Day &amp; 3 night"
              ...
              />
              <PackageCardGamma
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/package/p-gumma6.png"}
                cardLavel="3 Day &amp; 2 night"
