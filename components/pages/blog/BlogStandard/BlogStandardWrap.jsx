        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8">
              <StandardCard
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/blog/blog-thumb-xl1.png"}
                writter="John Smith"
              ...
              />
              <StandardCard
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/blog/blog-thumb-xl2.png"}
                writter="John Smith"
                date="September 10, 2022"
                title="Donec imperdiet est at ultrices sollicitudin urna metus iaculis odio eget efficitur leo eros id lectus."
              />
              <StandardCard
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/blog/blog-thumb-xl3.png"}
                writter="John Smith"
                date="September 10, 2022"
                title="Mauris variusnibh nulla. Morbi convallis finibus mi, et tincidunt odio. Donec eu aliquam arcu."
              />
              <StandardCard
                image={process.env.NEXT_PUBLIC_BASE_URL + "/images/blog/blog-thumb-xl4.png"}
                writter="John Smith"
                date="September 10, 2022"
