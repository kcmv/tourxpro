        ...
        <div className="container">
          ...
          <div className="row g-4">
            <div className="col-lg-4 col-md-6">
              <GuideCardAlpha image="/images/guide/guide-md1.png" name="Marvin McKinney" />
            </div>
            <div className="col-lg-4 col-md-6">
              <GuideCardAlpha image= "/images/guide/guide-m2.png" name="Charlotte Sophia" />
            </div>
            <div className="col-lg-4 col-md-6">
              <GuideCardAlpha image="/images/guide/guide-md3.png" name="Brooklyn Simmons" />
            </div>
          </div>
        </div>
      </div>
