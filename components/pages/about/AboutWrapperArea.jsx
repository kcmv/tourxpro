              ...
              <div className="col-lg-6">
                <div className="about-tab-image-grid text-center">
                  <div className="about-video d-inline-block">
                    <Image src="/images/about/about-g2.png" height={280} width={400} alt="aboutIMG" />
                  ...
                  <div className="row float-images g-4">
                    <div className="col-lg-6 col-md-6 col-sm-6">
                      <div className="about-image">
                        <Image src="/images/about/about-g1.png" height={370} width={400} alt="aboutIMG" />
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-6">
                      <div className="about-image">
                        <Image src="/images/about/about-g3.png" height={370} width={400} alt="aboutIMG" />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="row pt-110">
            ...
            <div className="col-lg-6">
              <div className="about-image-group mt-5 mt-lg-0">
                <Image src="/images/about/about-image-group2.png" className="img-fluid" height={600} width={600} alt="aboutIMG" />
              </div>
            </div>
          </div>
        </div>
